...
echo "Calculating thetas for Group 2 (modern samples only, n=33)..."
echo "Start time: $(date)"

realSFS lava_gulls_saf_group2.saf.idx > lava_gulls_group2_modern.sfs
...
angsd -bam $BAM_LIST \
      ...
      -doThetas 1 -doSaf 1 \
      -pest lava_gulls_group2_modern.sfs \
      -GL 1 \
      -minMapQ 30 -minQ 20 \
      -out lava_gulls_thetas_group2_modern \
      -nThreads 12
