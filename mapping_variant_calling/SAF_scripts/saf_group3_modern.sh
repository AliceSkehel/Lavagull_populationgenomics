...
echo "=========================================="
echo "Group 3: Chr4-10 (modern samples, n=33)"
echo "=========================================="
...
angsd -bam $BAM_LIST \
      ...
      -out lava_gulls_saf_group3_modern \
      -nThreads 12

echo "SAF complete!"

echo "Step 2: Calculating SFS..."
realSFS lava_gulls_saf_group3_modern.saf.idx > lava_gulls_group3_modern.sfs

echo "SFS complete!"

echo "Step 3: Calculating thetas..."
realSFS saf2theta lava_gulls_saf_group3_modern.saf.idx \
                   -sfs lava_gulls_group3_modern.sfs \
                   -outname lava_gulls_thetas_group3_modern
...
echo "=========================================="
echo "GROUP 3 COMPLETE! End time: $(date)"
echo "=========================================="
