...
echo "=========================================="
echo "Group 4c: Scaffolds (modern samples, n=33)"
echo "=========================================="
...
angsd -bam $BAM_LIST \
      ...
      -out lava_gulls_saf_group4c_modern \
      -nThreads 12

echo "SAF complete!"

echo "Step 2: Calculating SFS..."
realSFS lava_gulls_saf_group4c_modern.saf.idx > lava_gulls_group4c_modern.sfs

echo "SFS complete!"

echo "Step 3: Calculating thetas..."
realSFS saf2theta lava_gulls_saf_group4c_modern.saf.idx \
                   -sfs lava_gulls_group4c_modern.sfs \
                   -outname lava_gulls_thetas_group4c_modern
...
echo "=========================================="
echo "GROUP 4c COMPLETE! End time: $(date)"
echo "=========================================="
